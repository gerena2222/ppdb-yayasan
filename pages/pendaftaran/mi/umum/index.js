      ...
      <section className='py-5'>
        <div className="container">
          <div className="py-2 text-center">
            <h2 className='text-uppercase'>Pendaftaran Madrasah Ibtidaiyah Yayasan Saddam Al-Abror</h2>
          </div>
                    ...
                    <div className="col-md-12">
                      <div className='row mb-3'>
                        <div className='col-md-6'>
                          ...
                          <input className="form-control" type="text" disabled value="MI Yayasan Saddam Al-Abror"/>
                        </div>
                        <div className='col-md-6'>
                          <label className='mb-2'>Jalur </label>
                          <input className="form-control" type="text" disabled value="Umum" />
                        </div>
                      </div>
                      <div className="mb-3">
